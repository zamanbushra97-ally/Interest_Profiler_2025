...
# Format: (ID, Question Text, Yes Trait, No Trait)
# Selecting 5 from each block of 10 to ensure balance (5 Yes->Trait A, 5 Yes->Trait B per axis)
...
selected_questions = [
    ...
    (18, "Do you enjoy participating in group activities and events?", "E", "I"),
    ...
    (35, "Do you often find yourself imagining future possibilities and scenarios?", "N", "S"),
    ...
    (57, "Do you prefer to show empathy and understanding in your interactions?", "F", "T"),
    ...
    (76, "Do you prefer to go with the flow rather than sticking to a rigid schedule?", "P", "J"),
